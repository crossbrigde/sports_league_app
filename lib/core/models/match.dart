...
class Match {
  ...
  Match copyWith({
    ...
    String? bracket,
    bool? isGrandFinal,
    bool? isGrandFinalRematch,
    String? loserSlotInNext,
    ...
    isGrandFinalRematch: isGrandFinalRematch ?? this.isGrandFinalRematch,
    loserSlotInNext: loserSlotInNext ?? this.loserSlotInNext,
